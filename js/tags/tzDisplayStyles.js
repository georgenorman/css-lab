 ...
 *
 *      <tzDisplayStyles styleName="position">outermost, middleGrid, innerBox</tzDisplayStyles>
 *
...
var tzDisplayStylesTag = (function(tzDomHelper, tzCustomTagHelper) {
  ...
  return {
    ...
    render: function(containerNode, context) {
      ...
      if (tzDomHelper.isNotEmpty(context.comment)) {
        tzDomHelper.createElementWithAdjacentHtml(containerNode, "p", '{"className":"tz-code-example-comment"}', context.comment);
      }
  ...
  function renderAsMatrix(containerNode, context) {
    ...
    var wrapper = tzDomHelper.createElement(null, "div", '{"className":"tz-display-styles-matrix"}');
